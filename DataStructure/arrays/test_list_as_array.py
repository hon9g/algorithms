...
class Test(unittest.TestCase):
    ...
    def test_isEmpty(self):
        self.array = []
        self.assertEqual(False, False if self.array == [] else True)
        self.assertEqual(False, False if not self.array else True)
        self.array = [3]
        self.assertEqual(True, False if self.array == [] else True)
        self.assertEqual(True, False if not self.array else True)
